...
- Five wizard presets (SaaS 3 Column, Startup Pricing Grid, Service Columns, Feature Comparison Table, Service Plans) map to distinct FireVPS systems (colors, card style, CTA treatment, specs styling) and will use the appropriate layout partial.
